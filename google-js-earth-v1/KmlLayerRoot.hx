...
*/
public function getLayerById( id : String ) : KmlFolder;

/*
Enables a layer based on its ID. Parameters:
  idID of layer. See the GEPlugin object reference for possible values. visibilitySpecifies whether the feature is drawn in the 3D viewer when it is initially loaded. In order for a feature to be visible, visibility must also be set to 1.
*/
public function enableLayerById( id : String, visibility : Bool ) : Void;
